...
public:
  ...
  /// Loads a file into the editor. Returns true if the file was successfully
  /// loaded.
...
public slots:
   ...
   * Called whenever the user requested to change the current input type
   * (Assembly or C)
   */
   ...
   * Called whenever the user wants to switch from binary/ELF file input to
