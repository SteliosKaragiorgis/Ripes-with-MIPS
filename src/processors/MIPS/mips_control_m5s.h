...
class MIPS_Control_M5S : public Component {
public:
  /* clang-format off */
    ...
    static MIPS_CompOp do_comp_ctrl(const VSRTL_VT_U& opc) {
        switch(opc){
            ...
            case MIPS_Instr::BGEZ : return MIPS_CompOp::GE;
    ...
    /*static MIPS_AluSrc1 do_alu_op1_ctrl(const VSRTL_VT_U& opc) {
        switch(opc) {
            case MIPS_Instr::J: case MIPS_Instr::JAL:
            case MIPS_Instr::BEQ: case MIPS_Instr::BNE: case MIPS_Instr::BLT:
            case MIPS_Instr::BGE: case MIPS_Instr::BLTU: case MIPS_Instr::BGEU:
                return AluSrc1::PC;
            default:
                return AluSrc1::REG1;
        }
    ...
    static MIPS_ALUOp do_alu_ctrl(const VSRTL_VT_U& opc) {
        switch(opc) {
            ...
            //case MIPS_Instr::ADDIU  : return MIPS_ALUOp::ADDIU ;
...
public:
  MIPS_Control_M5S(const std::string &name, SimComponent *parent)
    ...
    mem_do_read_ctrl << [=] { return do_do_read_ctrl(opcode.uValue()); };               //MemRead
  }
