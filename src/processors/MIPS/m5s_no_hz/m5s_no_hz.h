...
#include "../m5s_unopt_no_fw_hz/m5s_unopt_no_fw_hz_exmem.h"
#include "../m5s_no_fw_hz/m5s_no_fw_hz_memwb.h"

#include "../../MIPS/m5s/m5s_forwardingunit.h"

/*
#include "../m5s_no_fw_hz/m5s_no_fw_hz_exmem.h"
*/
...
class M5S_NO_HZ : public RipesVSRTLProcessor {
...
public:
  ...
  M5S_NO_HZ(const QStringList &extensions)
      : RipesVSRTLProcessor("5-Stage MIPS Processor without forwarding or hazard detection") {
  ...
  SUBCOMPONENT(exmem_reg, TYPE(MIPS_EXMEM_UNOPT<XLEN>));
