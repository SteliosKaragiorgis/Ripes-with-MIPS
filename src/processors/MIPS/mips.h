...
Enum(MIPS_Instr, NOP,
     ...
     ADD, ADDU, AND, DIV, DIVU, MULT, MULTU, NOR, OR, SLL, SLLV, SRA, SRAV, SRL,
     SRLV, SUB, SUBU, XOR, SLT, SLTU, JALR, JR, MFHI, MFLO, MTHI, MTLO, BREAK,
     SYSCALL,

     /* MIPS32 I-TYPE Standard Extension */
     ADDI, ADDIU, ANDI, ORI, XORI, LHI, LLO, SLTI, SLTIU, BEQ, BGEZ, BGTZ, BLEZ,
     BLTZ, BNE, LB, LBU, LH, LHU, LUI, LW, LWC1, SB, SH, SW, SWC1, TRAP,
...
Enum(MIPS_ALUOp, NOP, ADD, ADDU, AND, DIV, DIVU, MULT, MULTU, NOR, OR, SLL,
     SLLV, SLT, SLTU, SRA, SRAV, SRL, SRLV, SUB, SUBU, XOR, LB, LBU, LH, LHU,
     LT, LTU, SL, LUI, SLTI, SLTIU, SH, XORI, MFHI, MFLO, MTHI, MTLO,
     BGLZ); // BGL-Branch Greater Less Zero
...
Enum(MIPS_ECALL, none, print_int = 1, print_char = 2, print_string = 4,
     exit = 10);
...
Enum(MIPSMulti_States, S0, S1, S2, S3, S4, S5, S6, S7, S8, S9, S10, S11, S12,
     S13, S14, S15, S16);
