...
#include "m5s_hazardunit.h"
#include "m5s_forwardingunit.h"
...
class M5S : public RipesVSRTLProcessor {
...
public:
  ...
  M5S(const QStringList &extensions)
  ...
  // Hazard unit
  SUBCOMPONENT(hzunit, MIPS_HazardUnit);
  ...
  StageInfo stageInfo(StageIndex stage) const override {
    ...
    // clang-format off
        ...
        /// ID
            ...
            ifid_reg->pc_reg->out.setActivePath(false);
        ...
        /// EX
            ...
            idex_reg->mem_do_read_ctrl_reg->out.setActivePath(false);
            ...
            if(stageValid){
                ...
                idex_reg->mem_do_read_ctrl_reg->out.setActivePath(true);
                ...
                switch(idex_reg->opcode_out.uValue()){
                    ...
                    case MIPS_Instr::JAL: case MIPS_Instr::J: {
                        ...
                        idex_reg->pc_reg->out.setActivePath(true);
                        idex_reg->reg1_idx_reg->out.setActivePath(false);
                        idex_reg->reg2_idx_reg->out.setActivePath(false);

                        idex_reg->instr_25_0_reg->out.setActivePath(true);
                        idex_reg->imm_reg->out.setActivePath(true);
        ...
        /// WB
            ...
            if(stageValid){
                ...
                switch(memwb_reg->opcode_reg->out.uValue()){
                    ...
                    case MIPS_Instr::LB: case MIPS_Instr::LBU: case MIPS_Instr::LH:
                    case MIPS_Instr::LHU: case MIPS_Instr::LW: {
                        memwb_reg->write_reg_reg->out.setActivePath(true);
