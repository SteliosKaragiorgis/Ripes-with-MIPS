...
class MIPS_EXMEM_UNOPT : public Component {
public:
  MIPS_EXMEM_UNOPT(const std::string &name, SimComponent *parent)
    ...
    CONNECT_REGISTERED_CLEN_INPUT(alugreater, clear, enable);
    CONNECT_REGISTERED_CLEN_INPUT(aluless, clear, enable);
...
*/
  ...
  REGISTERED_CLEN_INPUT(alugreater, 1);
  REGISTERED_CLEN_INPUT(aluless, 1);
