      ...
      case 0x00: // quadrant
        ...
        case 0b000: {       // c.addi4spn
          if (instrValue) { // not illegal instruction
            const auto fields =
                MIPS_InstrParser::getParser()->decodeR32Instr(instrValue);
            rd = fields[3] | 0x8;
        ...
        case 0b010: { // c.lw
          ...
          rd = fields[5] | 0x8;
          rs1 = fields[3] | 0x8;
          uimm = ((fields[4] & 0x01) << 6) | (fields[2] << 3) |
                 ((fields[4] & 0x02) << 1);
      ...
      case 0x01: // quadrant
        ...
        case 0b001:
          if (m_isa->isaID() == ISA::RV32I) { // c.jal
            ...
            imm = (((fields[2] & 0x040) << 3) | (fields[2] & 0x180) |
                   ((fields[2] & 0x010) << 2) | (fields[2] & 0x020) |
                   ((fields[2] & 0x001) << 4) | ((fields[2] & 0x200) >> 6) |
                   ((fields[2] & 0x00E) >> 1));
            if (fields[2] & 0x400) {
              imm = imm | 0xFFE00;
            }
        ...
        case 0b110: { // c.beqz
          const auto fields =
              MIPS_InstrParser::getParser()->decodeR32Instr(instrValue);
          rs1 = fields[3] | 0x8;
          imm = ((fields[4] & 0x18) << 2) | ((fields[4] & 0x01) << 4) |
                ((fields[2] & 0x03) << 2) | ((fields[4] & 0x06) >> 1);
          if (fields[2] & 0x04) {
            imm = 0xFF80 | imm;
          }
        ...
        case 0b011:
          if (m_isa->isaID() == ISA::RV64I) { // c.ldsp
            const auto fields =
                MIPS_InstrParser::getParser()->decodeR32Instr(instrValue);
            rd = fields[3];
            uimm = ((fields[4] & 0x07) << 6) | (fields[2] << 5) |
                   (fields[4] & 0x18);
            // ld rd,offset[8:3](x2)
