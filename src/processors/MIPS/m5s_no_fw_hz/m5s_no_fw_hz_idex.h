...
class MIPS_IDEX : public Component {
public:
  MIPS_IDEX(const std::string &name, SimComponent *parent)
  ...
  //REGISTERED_CLEN_INPUT(alu_op1_ctrl, c_MIPSRegsBits);
  ...
  //REGISTERED_CLEN_INPUT(br_op, MIPS_CompOp::width());
