...
#include "m5s_no_fw_hz_ifid.h"
#include "m5s_no_fw_hz_idex.h"
#include "m5s_no_fw_hz_exmem.h"
#include "m5s_no_fw_hz_memwb.h"
...
class M5S_NO_FW_HZ : public RipesVSRTLProcessor {
...
public:
  ...
  M5S_NO_FW_HZ(const QStringList &extensions)
      : RipesVSRTLProcessor("5-Stage MIPS Processor without forwarding unit") {
  ...
  SUBCOMPONENT(idex_reg, TYPE(MIPS_IDEX<XLEN>));
  SUBCOMPONENT(exmem_reg, TYPE(MIPS_EXMEM<XLEN>));
