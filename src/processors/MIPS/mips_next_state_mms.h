  ...
  MIPS_Next_State_MMS(const std::string &name, SimComponent *parent)
    ...
    next_state << [=] {
      ...
      case MIPSMulti_States::S1: {
        ...
        case MIPS_Instr::LHU:
        case MIPS_Instr::LW:
        case MIPS_Instr::LWC1:
        case MIPS_Instr::SB:
        case MIPS_Instr::SH:
        case MIPS_Instr::SW:
        case MIPS_Instr::SWC1:
          return MIPSMulti_States::S2;

        case MIPS_Instr::ADD:
        case MIPS_Instr::ADDU:
        case MIPS_Instr::AND:
        case MIPS_Instr::DIV:
        case MIPS_Instr::DIVU:
        case MIPS_Instr::XOR:
        case MIPS_Instr::MFHI:
        case MIPS_Instr::MFLO:
        ...
        case MIPS_Instr::SLT:
        case MIPS_Instr::SLTU:
        case MIPS_Instr::SRA:
        case MIPS_Instr::SRAV:
        case MIPS_Instr::SRL:
        case MIPS_Instr::SRLV:
        case MIPS_Instr::SUB:
        case MIPS_Instr::SUBU:
        case MIPS_Instr::JR:
        ...
        case MIPS_Instr::ADDI:
        case MIPS_Instr::ADDIU:
